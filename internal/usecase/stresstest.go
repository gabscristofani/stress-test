...
import (
	...
	"github.com/gabscristofani/stress-test/internal/adapters/client"
	"github.com/gabscristofani/stress-test/internal/entity"
)
...
func (uc *StressTestUseCase) Execute() StressTestOutput {
